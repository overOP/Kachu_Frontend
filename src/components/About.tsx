...
const About: React.FC = () => {
  return (
    <div className="bg-gray-100 py-16 px-4 flex flex-col items-center">
      ...
      <div className="relative max-w-7xl w-full h-96 md:h-105 lg:h-125 rounded-2xl overflow-hidden shadow-xl">
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="ml-6 md:ml-10 max-w-xl p-6 md:p-8 text-white 
                          ...
                          border border-l-10 border-green-500">

            {/* Title */}
            <h2 className="text-xl md:text-2xl font-semibold mb-4 text-green-400">
              Welcome to Kachu Cart
            </h2>

            <p className="text-sm md:text-base leading-relaxed text-gray-200">
              Welcome to Kachu Cart, your one-stop destination for a seamless and
            ...
            <p className="text-sm md:text-base mt-4 leading-relaxed text-gray-200">
              At Kachu Cart, we believe shopping should be simple, fast, and
